						...
						if(isset($_SESSION['YeuThich']) && $_SESSION['YeuThich'] != NULL)
						{
							...
							foreach ($_SESSION['YeuThich'] as $key => $item)
							{
								...
								<tr>
									...
									<td class="text-center" style="vertical-align: middle;"><a href="index.php?DatHang=DatHang&xoayeuthich=xoayeuthich&IDSP=<?php echo $key; ?>" ><img width="30px" src="quantri/assets/img/add.png"></a></td>
								</tr>
								<?php
								$stt++;
							}
